...
export default function CreateJobForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (MOCK_RECRUITER_COMPANY.activeJobsCount >= allowedLimit) {
      setError(
        `Job limit reached! Your ${MOCK_RECRUITER_COMPANY.plan} plan allows up to ${allowedLimit} active posts.`
      );
      return;
    }
    ...
    console.log("Submitting Active Job Payload:", jobPayload);
    setSuccess("Job posted successfully! It is now live and publicly visible.");
      ...
      <Form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Fieldset className="w-full">
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-6 items-end">
            ...
            {/* Composed V3 Switch layout built to capture state updates safely */}
